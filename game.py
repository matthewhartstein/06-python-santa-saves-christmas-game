...
#              The player controls a character (moved with arrow keys) on an 800x600 screen to avoid "Grinch" enemies
#              (which reduce health by 10 on collision)and collect "Elf" enemies (which add 10 to the score) and
#              "cookie" items (which restore health to 100).
